...
[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0 0 1], method);
label == 'blue'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0 1 0], method);
label == 'green'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([1 0 0], method);
label == 'red'
certainty == 'certain'


[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([1 1 0], method);
label == 'yellow'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0 0 0], method);
label == 'black'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([1 1 1], method);
label == 'white'
certainty == 'certain'
...
[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0.2 0.2 0.9], method);
label == 'blue'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0.2 0.9 0.2], method);
label == 'green'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0.9 0.2 0.2], method);
label == 'red'
certainty == 'certain'


[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0.9 0.9 0.2], method);
label == 'yellow'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0.2 0.15 0.2], method);
label == 'black' | secondary_label == 'black'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0.85 0.9 0.9], method);
label == 'white'
certainty == 'certain'
...
[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([254 121 164]/255, method);
label == 'red'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([169 36 74]/255, method);
label == 'red'
certainty == 'certain'
...
[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([1 85 66]/255, method);
label == 'green'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([65 153 122]/255, method);
label == 'green'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([59 136 213]/255, method);
label == 'blue'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0 42 102]/255, method);
label == 'blue'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([254 221 172]/255, method);
label == 'yellow'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([254 209 168]/255, method);
label == 'yellow'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0 0 2]/255, method);
label == 'black'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([0 1 0]/255, method);
label == 'black'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([171 115 119]/255, method);
label == 'red'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([187 184 177]/255, method);
label == 'white'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([90 156 100]/255, method);
label == 'green'
certainty == 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([169 160 161]/255, method);
(label == 'gray' | label == 'white') &  (secondary_label == 'gray' | secondary_label == 'white')

certainty ~= 'certain'

[label, certainty, confidence, secondary_label] = ..
  color_classify_single_c([121 180 2]/255, method);
label == 'green'
certainty == 'certain'
...
//imgo=imread('/home/rfabbri/lib/pics/test-imgs/color-webcam-orig/lenovo-orig/2011-10-10-155145.jpg');
imgo=imread('/home/rfabbri/lib/pics/test-imgs/color-webcam-db/misc/mp980.it8.jpg');
imgu=imgo(1:16:1536,1:16:2048,:);
//imgu=imgo(1:4:1536,1:4:2048,:);
